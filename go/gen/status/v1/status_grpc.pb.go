...
func (c *statusServiceClient) FetchStatus(ctx context.Context, in *FetchStatusRequest, opts ...grpc.CallOption) (*FetchStatusResponse, error) {
	out := new(FetchStatusResponse)
	err := c.cc.Invoke(ctx, "/status.v1.StatusService/FetchStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStatusServiceServer) FetchStatus(context.Context, *FetchStatusRequest) (*FetchStatusResponse, error) {
...
func _StatusService_FetchStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServiceServer).FetchStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.v1.StatusService/FetchStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServiceServer).FetchStatus(ctx, req.(*FetchStatusRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _StatusService_FetchStatus_Handler,
		},
	},
