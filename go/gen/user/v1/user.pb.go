...
func (x *FetchUserRequest) GetId() int64 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return 0
...
func (x *FetchUserResponse) GetUser() *UserMessage {
	if x != nil {
		return x.User
	}
	return nil
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x12, 0x13, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00,
	...
	0x61, 0x69, 0x6c, 0x22, 0x3d, 0x0a, 0x11, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72,
	...
	0x65, 0x72, 0x32, 0x53, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x44, 0x0a, 0x09, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x12, 0x19,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x88, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x6f, 0x2f, 0x67, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x76, 0x31,
...
var file_user_v1_user_proto_goTypes = []interface{}{
	...
	(*FetchUserRequest)(nil),  // 1: user.v1.FetchUserRequest
	(*FetchUserResponse)(nil), // 2: user.v1.FetchUserResponse
}
var file_user_v1_user_proto_depIdxs = []int32{
	0, // 0: user.v1.FetchUserResponse.user:type_name -> user.v1.UserMessage
	1, // 1: user.v1.UserService.FetchUser:input_type -> user.v1.FetchUserRequest
	2, // 2: user.v1.UserService.FetchUser:output_type -> user.v1.FetchUserResponse
